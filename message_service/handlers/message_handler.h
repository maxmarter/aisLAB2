...
public:
                       ...
                       HTTPServerResponse &response)
    {
        ...
        try
        {
            if (form.has("to_user_id") && (request.getMethod() == Poco::Net::HTTPRequest::HTTP_GET))
            {
                long id = atol(form.get("to_user_id").c_str());
            ...
            else if (request.getMethod() == Poco::Net::HTTPRequest::HTTP_POST)
            {
                if (form.has("to_user_id")) 
                {
                    ...
                    message.to_user_id() = std::stol(form.get("to_user_id"));
