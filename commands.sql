...
explain select * from Author where first_name='Филатова';
explain select * from Author where title='Longeroad';
explain select * from Author where id>10 and id<20;
explain select * from Author where first_name='Elle%';
insert into Author (first_name,last_name,email,title) values ('Петя','Кухьмин','petrputyaha@yandex.ru','исполнитель');
...
explain select * from Author where email='EddCarvahal@gmail.com';
